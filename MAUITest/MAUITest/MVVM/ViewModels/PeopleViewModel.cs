    ...
    public class PeopleViewModel
    {
        public PeopleViewModel()
        {
            People = new()
            {
                ...
                new Person { Name = "Ronal", Age = 18, BirthDate = new DateTime(1974, 9, 23), IsMarried =false, LunchTime = new TimeSpan(12, 30, 0), Weight = 89 },
                new Person { Name = "Valery", Age = 8, BirthDate = new DateTime(1974, 9, 23), IsMarried =false, LunchTime = new TimeSpan(12, 30, 0), Weight = 89 },
                new Person { Name = "Omaira", Age = 58, BirthDate = new DateTime(1974, 9, 23), IsMarried =true, LunchTime = new TimeSpan(12, 30, 0), Weight = 89 },
                new Person { Name = "Martiana", Age = 18, BirthDate = new DateTime(1974, 9, 23), IsMarried =false, LunchTime = new TimeSpan(12, 30, 0), Weight = 89 },
            };
        }
